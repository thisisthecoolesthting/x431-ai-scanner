...
A host-shell bridge MCP (PowerShell.MCP, cowork-terminal-mcp, Windows-MCP, win-cli-mcp-server, or equivalent) plugs this gap. On this machine, PowerShell.MCP is installed and registered in Claude Desktop's MCP config at %APPDATA%\Claude\claude_desktop_config.json.
...
## PowerShell.MCP-specific notes (this machine)

Bridge binary: C:\Users\reasn\Documents\PowerShell\Modules\PowerShell.MCP\1.8.0\bin\win-x64\PowerShell.MCP.Proxy.exe
...
Use C:\Users\reasn\Desktop\x431-foundation-push\ for the x431-ai-scanner repo. Do NOT use E:\Projects\CaseForge\x431-ai-scanner\ (that lives inside a different parent git repo pointing at a different GitHub remote).
