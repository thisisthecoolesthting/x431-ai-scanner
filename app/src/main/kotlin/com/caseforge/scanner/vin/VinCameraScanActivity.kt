...
class VinCameraScanActivity : ComponentActivity() {
    ...
    private fun launchCamera() {
        try {
            ...
            Log.e(TAG, "Camera launch failed", t)
            Toast.makeText(this, AppR.string.session_camera_launch_failed, Toast.LENGTH_LONG).show()
            finishCanceled()
        }
    }
        ...
        textRecognizer.process(image)
            .addOnSuccessListener { visionText ->
                ...
                if (best != null && VinNormalizer.isValidVin(best.normalizedVin)) {
                    ...
                    Toast.makeText(this, AppR.string.vin_scan_no_vin_found, Toast.LENGTH_LONG).show()
                    finishCanceled()
                }
            }
            .addOnFailureListener { e ->
                Log.e(TAG, "OCR failed", e)
                Toast.makeText(this, AppR.string.vin_scan_ocr_failed, Toast.LENGTH_LONG).show()
                finishCanceled()
            }
    }
