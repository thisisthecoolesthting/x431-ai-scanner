 ...
 *
 * C2: On first launch, shows [OverlayOnboarding] if [SettingsRepo.overlayOnboardingSeen]
 * is false. Otherwise, renders normal overlay content.
 *
...
fun OverlayRoot(
    ...
    // Normal overlay content (A4 + below)
...
private fun OverlayTopBar(
    ...
    TopAppBar(
        title = {
            Column {
                Text("Together Scanners AI", fontWeight = FontWeight.Bold)
                Text(
