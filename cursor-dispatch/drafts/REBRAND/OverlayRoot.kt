...
private fun OverlayTopBar(
    ...
    TopAppBar(
        title = {
            Column {
                Text("Together", fontWeight = FontWeight.Bold)
                Text(
...
private fun NoEngineHint() {
    Column(Modifier.fillMaxSize().padding(20.dp),
        ...
        Spacer(Modifier.height(6.dp))
        Text(
            "Tap any capability and Together Scanners AI will start the X431 engine for you. " +
...
private fun UnknownScreenView(hint: String) {
    Column(Modifier.fillMaxSize().padding(20.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        Text(
            "Together Scanners AI doesn't know this X431 screen yet. Tap Peek to use X431 directly, " +
